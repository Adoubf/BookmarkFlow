...
const translations = {
  zh: {
    ...
    'message.confirmClear': '确定要清除所有书签数据吗？此操作不可撤销。',
    ...
    // Footer
    'footer.description': '现代化的书签管理工具，让您的网址导航更加高效便捷。支持主流浏览器导入，本地处理保护隐私。',
  ...
  en: {
    ...
    'home.subtitle': 'Transform your browser bookmarks into a beautiful, searchable navigation experience.',
    'home.browserSupport': 'Support for Chrome, Firefox, Safari, and Edge.',
    
    // Features
    'features.smartSearch': 'Smart Search',
    'features.smartSearchDesc': 'Instantly find any bookmark with intelligent search across titles and URLs',
    'features.autoOrganization': 'Auto Organization',
    'features.autoOrganizationDesc': 'Preserve your folder structure and add smart tags automatically',
    'features.lightningFast': 'Lightning Fast',
    'features.lightningFastDesc': 'Navigate thousands of bookmarks with instant loading and smooth animations',
    ...
    // Messages
    'message.parseError': 'Failed to parse bookmark file. Please ensure it\'s a valid bookmark export.',
    'message.noBookmarks': 'No bookmarks found in the file.',
    'message.noNewBookmarks': 'No new bookmarks found. All bookmarks already exist.',
    'message.importSuccess': 'Imported {count} new bookmarks. Skipped {duplicates} duplicates.',
    'message.importFailed': 'Failed to import bookmarks',
    'message.confirmClear': 'Are you sure you want to clear all bookmark data? This action cannot be undone.',
    ...
    'chart.noDataDesc': 'Import some bookmarks to see beautiful distribution charts here',
    'chart.totalBookmarks': 'Total Bookmarks',
    'chart.totalFolders': 'Total Folders',
    'chart.avgPerFolder': 'Avg per Folder',
    
    // Footer
    'footer.description': 'Modern bookmark management tool for efficient and convenient web navigation. Supports mainstream browser imports with local processing for privacy protection.',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    try {
      const savedLang = localStorage.getItem('bookmarkflow-language') as Language;
